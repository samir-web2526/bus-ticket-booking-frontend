        ...
        <DialogHeader className="px-10 pt-10 pb-8 border-b border-border/50 relative shrink-0">
          <div className="flex items-center justify-between">
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
              <p className="text-amber-600 text-sm font-medium tracking-wide mb-2">Edit Operator</p>
              <DialogTitle className="text-foreground font-bold text-3xl tracking-tight leading-none">
                Edit <span className="text-amber-600">Operator</span>
              </DialogTitle>
            </motion.div>
        ...
        <div className="px-10 py-8 space-y-10 overflow-y-auto custom-scrollbar flex-1">
          <section className={sectionCls}>
            <div className="flex items-center gap-3 mb-2">
               ...
               <p className="text-xs font-medium text-muted-foreground opacity-50">Profile</p>
            </div>
            <div>
              ...
              <p className="text-xs font-medium text-muted-foreground/50 mt-2 ml-1">Cannot be changed</p>
            </div>
          ...
          <section className={sectionCls}>
            <div className="flex items-center gap-3 mb-2">
               ...
               <p className="text-xs font-medium text-muted-foreground opacity-50">Company Details</p>
            </div>
            <div>
              <label className={labelCls}>Company Name</label>
              <input type="text" value={form.companyName} onChange={(e) => handleChange("companyName", e.target.value)} placeholder="Enter company name" className={inputCls} />
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
            ...
            <div>
              ...
              <div className="relative">
                <textarea value={form.address} onChange={(e) => handleChange("address", e.target.value)} placeholder="Enter address..." className="w-full bg-muted/50 border border-border text-foreground rounded-2xl px-4 py-4 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500/20 transition-all duration-300 placeholder:text-muted-foreground/50 text-base font-normal" rows={3} />
