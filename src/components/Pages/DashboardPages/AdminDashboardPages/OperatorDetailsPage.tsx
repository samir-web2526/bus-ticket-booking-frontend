    ...
    try {
      ...
      const updatedOperator: Operator = {
        ...
        operatorProfile: operator.operatorProfile
          ? { ...operator.operatorProfile, companyName: form.companyName, address: form.address }
          : null,
      };
      ...
      <DialogContent className="bg-[#050d1a] border border-white/10 text-white max-w-lg rounded-3xl p-0 overflow-hidden shadow-2xl">
        ...
        <DialogHeader className="px-8 pt-8 pb-5 border-b border-white/10 relative">
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
            <p className="text-amber-400 text-xs font-semibold tracking-widest uppercase mb-1">— Edit Operator</p>
        ...
        <div className="px-8 py-6 space-y-6 relative max-h-96 overflow-y-auto">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <label className="text-sm font-bold text-amber-400 uppercase tracking-widest block mb-2">Company Name</label>
              ...
              <div>
                <label className="text-sm font-bold text-amber-400 uppercase tracking-widest block mb-2">Address</label>
                <textarea
                  value={form.address}
