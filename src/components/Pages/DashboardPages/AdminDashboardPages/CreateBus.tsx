...
//   vipSeats: z.number().min(0),
//   vipPrice: z.number().min(0),
//   deluxeSeats: z.number().min(0),
//   deluxePrice: z.number().min(0),
  ...
  return (
    <div className="min-h-screen bg-[#050d1a] p-6 lg:p-12 text-white">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* TITLE */}
        <h1 className="text-4xl font-bold mb-8">Create Bus</h1>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            {/* NUMBER INPUTS — FIXED WITH valueAsNumber */}
            ...
            <Input type="number"
              ...
              {...register("vipSeats", { valueAsNumber: true })}
            />
            ...
            <Input type="number"
              placeholder="Deluxe Seats"
              {...register("deluxeSeats", { valueAsNumber: true })}
            />
          ...
          <div>
            ...
            <h2 className="text-xl mb-4">Seat Preview</h2>
