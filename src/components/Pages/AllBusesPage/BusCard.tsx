...
const BusCard: React.FC<BusCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className="group"
    >
      <div className="relative overflow-hidden rounded-2xl bg-white shadow-lg hover:shadow-2xl transition-all duration-300 border border-amber-100">
        ...
        <div className="p-6 relative z-10">
          <div className="flex items-start justify-between mb-6">
            ...
            <div className="flex flex-col items-center gap-2 px-4">
              <div className="flex items-center gap-2">
                <div className="h-1 w-12 bg-gradient-to-r from-amber-400 to-orange-400" />
                <Clock className="w-4 h-4 text-amber-500" />
                <div className="h-1 w-12 bg-gradient-to-r from-orange-400 to-amber-400" />
              </div>
              <span className="text-xs font-semibold text-gray-600 bg-amber-100 px-2 py-1 rounded-full">
                {duration}
              </span>
            </div>
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              <p className="text-xs text-gray-600">From</p>
              <p className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-orange-500">
                ৳{price}
              </p>
            </div>
          </div>
          ...
          {amenities.length > 0 && (
            <div className="flex flex-wrap gap-2 mb-4">
              ...
              {amenities.length > 3 && (
                <span className="text-xs px-2 py-1 bg-amber-50 text-amber-700 rounded-lg border border-amber-100">
                  +{amenities.length - 3} more
                </span>
              )}
            </div>
            ...
            <Button
              ...
              className={`w-full h-11 rounded-xl font-semibold flex items-center justify-center gap-2 transition-all duration-300 ${
                !isActive
                  ...
                  : 'bg-gradient-to-r from-amber-500 to-orange-500 text-white hover:from-amber-600 hover:to-orange-600 hover:shadow-lg hover:shadow-amber-500/30'
              }`}
            >
              View Details
              {isActive && <ArrowRight className="w-4 h-4" />}
