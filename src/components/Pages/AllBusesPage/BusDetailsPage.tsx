...
//       try {
//         setLoading(true);
//         const response = await fetch(`/api/v1/buses/${busId}`, {
//           method: 'GET',
//           headers: { 'Content-Type': 'application/json' },
//         });
...
//         setError(message);
//         console.error('[fetchBusDetails]', message);
//       } finally {
//         setLoading(false);
//       }
//     };
...
//       {/* Header */}
//       <div className="bg-linear-to-r from-blue-600 to-cyan-600 text-white py-8">
...
//                 <div className="bg-linear-to-r from-blue-50 to-cyan-50 p-6 border-b">
...
//                 <CardHeader className="bg-linear-to-r from-blue-50 to-cyan-50 pb-4">
...
//                       />
//                     ) : (
//                       <div className="w-16 h-16 rounded-full bg-linear-to-br from-blue-400 to-cyan-400 flex items-center justify-center text-white font-bold text-xl">
...
//                       className={`w-full h-12 rounded-lg font-bold text-base transition-all duration-300 ${
//                         isBookingDisabled
...
//                     </div>
//                     <div className="flex items-center gap-2">
//                       <div className="w-6 h-6 bg-linear-to-r from-blue-600 to-cyan-600 rounded" />
...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Separator } from '@/components/ui/separator';
import { getBusById } from '@/app/actions/busActions'; // আপনার server action import করুন
...
const BusDetailsPage: React.FC = () => {
  ...
  // Fetch bus details using server action
  useEffect(() => {
